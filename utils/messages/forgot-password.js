export const isNotExist = () => {
    ...
    <br>
    <a href="https://yourspeakingfriend.netlify.app/signup" style="color: #fff; background-color: #2208CC; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">Sign Up</a>
    <br>
    <p>Thanks,</p>
    <b>The Chat Team</b>
    `
